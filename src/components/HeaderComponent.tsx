...
function HeaderComponent({ links }: HeaderProps){
  ...
  return (
    <div className="flex flex-row justify-between h-15 sm:h-20 lg:h-36 items-center px-8 bg-black">
      <div className="absolute top-1 lg:top-2 -left-2 sm:h-40 sm:-left-1 lg:left-0 h-30 lg:h-64 z-1 cursor-pointer" onClick={() => {navigate('/joker')}}>
        <img src="./JokerLogo.svg" alt="joker logo" className="h-full w-full"/>
      </div>
